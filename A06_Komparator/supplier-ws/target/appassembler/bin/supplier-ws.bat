...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="supplier-ws" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" org.komparator.supplier.ws.SupplierApp %CMD_LINE_ARGS%
