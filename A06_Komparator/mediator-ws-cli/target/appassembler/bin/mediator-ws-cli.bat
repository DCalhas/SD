...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="mediator-ws-cli" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" org.komparator.mediator.ws.cli.MediatorClientApp %CMD_LINE_ARGS%
