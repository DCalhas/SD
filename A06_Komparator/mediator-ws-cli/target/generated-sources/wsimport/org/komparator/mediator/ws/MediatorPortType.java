...
public interface MediatorPortType {
    ...
    public void updateCart(
        @WebParam(name = "cartView", targetNamespace = "")
        CartView cartView,
    ...
    public void updateShopHistory(
        @WebParam(name = "shoppingResultView", targetNamespace = "")
        ShoppingResultView shoppingResultView,
        @WebParam(name = "cartView", targetNamespace = "")
        CartView cartView,
        @WebParam(name = "operationId", targetNamespace = "")
        String operationId);
    ...
    @Action(input = "http://ws.mediator.komparator.org/Mediator/clearRequest")
    public void imAlive();
