...
public class MediatorEndpointManager {
	...
	private String uddiURLBackup = null;
	/** Web Service name */
	...
	public String getUDDIBackup() { return this.uddiURLBackup; }
	
	public void setUDDIurl(String uddiURL) { this.uddiURL = uddiURL; }
	...
	public MediatorEndpointManager(String uddiURL, String wsName, String wsURL) {
		if(!wsURL.contains("8072"))
			this.uddiURL = uddiURL;
		this.uddiURLBackup = uddiURL;
		this.wsName = wsName;
		this.wsURL = wsURL;
	}
